        ...
        child: SafeArea(
          child: Stack(
            children: [
              ...
              // Ondo greets in the middle.
              Align(
                alignment: const Alignment(0, .1),
                child: GestureDetector(
                  onTap: Feel.tap,
                  child: const Ondo(size: 140),
                ),
              ),
              // The one door: Amara's sorting scene.
              Align(
                alignment: const Alignment(.7, .55),
                child: GestureDetector(
                  onTap: () {
                    Feel.tap();
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => const SortingScene()));
                  },
                  child: Column(
                    ...
                    children: const [
                      ...
                      Icon(Icons.pan_tool_alt_rounded,
                          size: 34, color: Color(0xFFAB47BC)),
                    ],
                  ),
                ),
              ),
          ...
          children: [
            Center(
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Ondo(size: 130, sleepy: true),
