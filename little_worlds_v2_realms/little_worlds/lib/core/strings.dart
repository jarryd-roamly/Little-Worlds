/// Localization, kept deliberately tiny:
/// the CHILD experience is text-free (icons, audio, demonstration),
/// so only parent-zone text needs translating. Add a language = add a map.
class S {
